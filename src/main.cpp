...
const int NUM_LEDS = PACMAN_OUTLINE_LEDS + PACMAN_RAYS_LEDS*2;
...
void setup() {
  FastLED.addLeds<NEOPIXEL, STRIP_1_PIN>(leds, 0, PACMAN_OUTLINE_LEDS);
  FastLED.addLeds<NEOPIXEL, STRIP_2_PIN>(leds, 0, PACMAN_OUTLINE_LEDS);
  FastLED.addLeds<NEOPIXEL, STRIP_3_PIN>(leds, PACMAN_OUTLINE_LEDS, PACMAN_RAYS_LEDS);
  FastLED.addLeds<NEOPIXEL, STRIP_4_PIN>(leds, PACMAN_OUTLINE_LEDS, PACMAN_RAYS_LEDS);
  FastLED.addLeds<NEOPIXEL, STRIP_5_PIN>(leds, PACMAN_OUTLINE_LEDS + PACMAN_RAYS_LEDS, PACMAN_RAYS_LEDS);
  FastLED.addLeds<NEOPIXEL, STRIP_6_PIN>(leds, PACMAN_OUTLINE_LEDS + PACMAN_RAYS_LEDS, PACMAN_RAYS_LEDS);
  printf(NUM_LEDS);
  // x = random16();
  // y = random16();
  // z = random16();
